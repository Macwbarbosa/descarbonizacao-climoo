...
export { default as InitiativesManagementPage } from './initiatives-management/InitiativesManagementPage';
export { TechnologyBankPage as TechnologiesBankPage } from './initiatives-bank';
